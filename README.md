...
Currently:
* Wins 2-player a little more than 25% of the time, with an average score of around 16.
* Wins 3-player around 12% of the time, with an average score of 18-19.
* Wins 4-player around 4% of the time, with an average score of 17-18.
