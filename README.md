...
Currently:
* Wins 2-player around 38% of the time, with an average score of around 19.
* Wins 3-player around 24% of the time, with an average score of around 20.
* Wins 4-player around 7% of the time, with an average score of around 19.
