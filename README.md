...
Currently:
* Wins 2-player around 40% of the time, with an average score of around 19.
* Wins 3-player around 26% of the time, with an average score of around 21.
* Wins 4-player around 8% of the time, with an average score of around 19.
